...
/* user/show.html.twig */
class __TwigTemplate_fc1eca90ae8057cfe8f2358ded6618ba extends Template
{
    ...
    <table class=\"table\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 24
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 24, $this->source); })()), "roles", [], "any", false, false, false, 24)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(json_encode(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 24, $this->source); })()), "roles", [], "any", false, false, false, 24)), "html", null, true)) : (""));
        yield "</td>
            </tr>
            <tr>
                <th>Password</th>
...
{% endblock %}
", "user/show.html.twig", "C:\\xampp\\htdocs\\Artiste\\templates\\user\\show.html.twig");
    }
}
