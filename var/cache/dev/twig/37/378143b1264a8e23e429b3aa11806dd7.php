...
class __TwigTemplate_8d8e7ce9161a35393f4b77f1cda4517b extends Template
{
    ...
    public function block_meta_keywords(array $context, array $blocks = []): iterable
    {
        ...
        yield "contact, email, message, reach out";
...
{% block title %}Contact - Artty{% endblock %}

{% block meta_description %}Get in touch with me{% endblock %}
{% block meta_keywords %}contact, email, message, reach out{% endblock %}
...
{% endblock %}", "front/contact.html.twig", "C:\\xampp\\htdocs\\Artiste\\templates\\front\\contact.html.twig");
    }
}
